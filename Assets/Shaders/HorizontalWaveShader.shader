Shader "Custom/HorizontalWaveShader"
{
    Properties
    {
...
// shlomi was here
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                // Apply a horizontal sinusoidal wave distortion to the vertex position
                float waveOffset = sin(_Time * _WaveSpeed + v.vertex.y * 10.0) * _WaveStrength;
